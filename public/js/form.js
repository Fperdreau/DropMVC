...
var validsubmitform = function (el, data, callback, timing) {
    ...
    var result = (typeof data !== 'object') ? jQuery.parseJSON(data) : data;
    callback = (callback === undefined) ? false : callback;
    ...
    if (result.status === true) {
        msg = (result.msg === undefined) ? "<div class='msg_success'>DONE!</div>" :
            "<div class='msg_success'>" + result.msg + "</div>";
    } else if (result.status !== undefined) {
        msg = (result.msg === undefined) ? "<p class='msg_warning'>Oops, something has gone wrong!</p>" :
        "<div class='msg_warning'>" + result.msg + "</div>";
    }
