 ...
 *
 */
class TasksController extends \App\Controller\TasksController {

    /**
     * Renders Scheduled tasks page
     */
    public function index() {
        $cronList = $this->Tasks->getJobs();
        $cronList = $this->view->all($cronList);
        $this->render('admin.tasks.index',compact('cronList'));
    }
