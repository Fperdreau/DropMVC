 ...
 */
class Plugins extends AppModel {
     ...
     */
    public function get() {
        $data = $this->db->select($this->tablename,array('*'), array('name'=>$this->name));
        if (!empty($data)) {
    ...
    public function delete() {
        $this->db->delete($this->db->tablesname['Plugins'],array('name'=>$this->name));
    ...
    public function update($post=array()) {
        $class_vars = get_class_vars('AppPlugins');
        $content = $this->parsenewdata($class_vars,$post,array('installed'));
        return $this->db->update($this->db->tablesname['Plugins'],$content,array("name"=>$this->name));
    }
